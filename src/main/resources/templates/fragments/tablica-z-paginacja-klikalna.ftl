<#macro paginated_clickable_table thValues tableContent parametrSortowania kierunekSortowania currentPage totalPages functionName>
    <div class="container centered-container">
        <table id="flight-table" class="table table-striped table-dark table-bordered" style="width:100%">
            ...
            <tbody>
            <#list tableContent as row, id>
                <tr class="clickable mousePointer" onclick="${functionName}(${id?string.c})">
                    ${row}
                </tr>
            </#list>
            </tbody>
